...
#+BEGIN_SRC sh
mbpoll -0 -B -m rtu -a 3 -b 9600 -l 200 -t 4 -r 0 -c 1 -P none /dev/ttyS0
#+END_SRC
...
Reading example:
#+BEGIN_EXAMPLE
$ mbpoll -B -m rtu -a 10 -b 9600 -t 4 -r 1 -c 32 -P none /dev/ttyS0
...
*** OUTPUT
Output module similar to input module. Protocol configuration and write example.
#+BEGIN_EXAMPLE
mbpoll -0 -m rtu -a 20 -b 19200 -t 4 -r 3 -P none /dev/ttyS0 1 0 1

Protocol configuration: Modbus RTU
Slave configuration...: address = [20]
                        start reference = 3, count = 3
Communication.........: /dev/ttyS0,       9600-8N1 
                        t/o 1.00 s, poll rate 1000 ms
Data type.............: 16-bit register, output (holding) register table
